  ...
  api: [
    ...
    },
    {
      description:
        ...
        'XML формируется по официальной XSD-схеме Рослесхоза и отдаётся пользователю ' +
        'файлом на скачивание — только если он прошёл валидацию. Коды строк и единицы ' +
        'измерения подставляются из формы приказа № 112, контрольные суммы вложений ' +
        'считаются по файлам. Не пересказывай содержимое XML в ответе: дай ссылку на файл.',
