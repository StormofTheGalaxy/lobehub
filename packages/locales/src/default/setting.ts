...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspaceSetting.invitePage.accepted.desc':
    'You joined “{{name}}”. Shared agents, knowledge, providers and team limits are available now.',
  'workspaceSetting.invitePage.accepted.enter': 'Open workspace',
  'workspaceSetting.invitePage.accepted.title': 'Invitation accepted',
  'workspaceSetting.invitePage.accepting.desc': 'Connecting you to the workspace.',
  'workspaceSetting.invitePage.accepting.title': 'Accepting the invitation',
  'workspaceSetting.invitePage.badge': 'Workspace invite',
  'workspaceSetting.invitePage.checking': 'Checking',
  'workspaceSetting.invitePage.error.desc':
    'The link may have expired, been revoked by the owner, or already been used. Ask a workspace owner to send a new invitation.',
  'workspaceSetting.invitePage.error.generic': 'Could not accept the invitation.',
  'workspaceSetting.invitePage.error.home': 'Go home',
  'workspaceSetting.invitePage.error.missingToken': 'The invite link is incomplete or damaged.',
  'workspaceSetting.invitePage.error.missingWorkspace':
    'The workspace for this invitation no longer exists.',
  'workspaceSetting.invitePage.error.retry': 'Try again',
  'workspaceSetting.invitePage.error.title': 'Could not accept the invitation',
  'workspaceSetting.invitePage.ready.accept': 'Accept invitation',
  'workspaceSetting.invitePage.ready.desc':
    'Accept the invitation to add this account to the workspace.',
  'workspaceSetting.invitePage.ready.title': 'You have been invited to a workspace',
  'workspaceSetting.members.addDirect.action': 'Add without an invite',
  'workspaceSetting.members.addDirect.error': 'Could not add this member',
  'workspaceSetting.members.addDirect.placeholder': 'User ID to add directly',
  'workspaceSetting.members.addDirect.success': 'Member added',
  'workspaceSetting.members.desc':
    'Invite people with a link, assign roles, and keep access to shared agents, knowledge, providers and credits under control.',
  'workspaceSetting.members.invitations.copyLink': 'Copy link',
  'workspaceSetting.members.invitations.linkInvite': 'Invite link',
  'workspaceSetting.members.invitations.open': 'Open',
  'workspaceSetting.members.invitations.revoke': 'Revoke',
  'workspaceSetting.members.invitations.revokeDesc': 'The link stops working immediately.',
  'workspaceSetting.members.invitations.revokeError': 'Could not revoke this invitation',
  'workspaceSetting.members.invitations.revokeSuccess': 'Invitation revoked',
  'workspaceSetting.members.invitations.revokeTitle': 'Revoke this invitation?',
  'workspaceSetting.members.invitations.title': 'Pending invitations',
  'workspaceSetting.members.invite.copied': 'Link copied',
  'workspaceSetting.members.invite.copy': 'Copy',
  'workspaceSetting.members.invite.create': 'Create invite link',
  'workspaceSetting.members.invite.desc':
    'We create a single-use invite link and copy it to your clipboard right away. After signing in, the invitee lands in this workspace.',
  'workspaceSetting.members.invite.error': 'Could not create the invite link',
  'workspaceSetting.members.invite.ready': 'The link is ready and already copied.',
  'workspaceSetting.members.invite.title': 'Invite to this workspace',
  'workspaceSetting.members.list.counter': '{{shown}} of {{total}}',
  'workspaceSetting.members.list.emptyDesc': 'Try another search or role filter.',
  'workspaceSetting.members.list.emptyTitle': 'No one matches',
  'workspaceSetting.members.list.search': 'Search by name, email or ID',
  'workspaceSetting.members.list.title': 'Members',
  'workspaceSetting.members.noWorkspace': 'Pick a workspace to manage its members.',
  'workspaceSetting.members.readOnlyNotice':
    'Roles and invitations are available to workspace owners and super admins.',
  'workspaceSetting.members.remove.action': 'Remove',
  'workspaceSetting.members.remove.desc':
    '{{name}} loses access to this workspace — its agents, knowledge and credits.',
  'workspaceSetting.members.remove.error': 'Could not remove this member',
  'workspaceSetting.members.remove.success': 'Member removed',
  'workspaceSetting.members.remove.title': 'Remove this member?',
  'workspaceSetting.members.role.admin': 'Admin',
  'workspaceSetting.members.role.all': 'All roles',
  'workspaceSetting.members.role.member': 'Member',
  'workspaceSetting.members.role.owner': 'Owner',
  'workspaceSetting.members.role.primaryOwner': 'Primary owner',
  'workspaceSetting.members.role.readonly': 'Only the workspace owner can change roles.',
  'workspaceSetting.members.role.updateError': 'Could not change the role',
  'workspaceSetting.members.role.updateSuccess': 'Role updated',
  'workspaceSetting.members.role.viewer': 'Viewer',
  'workspaceSetting.members.stat.canManage': 'You can manage',
  'workspaceSetting.members.stat.members_other': '{{count}} members',
  'workspaceSetting.members.stat.members_one': '{{count}} member',
  'workspaceSetting.members.stat.pending': '{{count}} pending',
  'workspaceSetting.members.title': 'Workspace team',
