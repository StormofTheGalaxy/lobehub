export default {
  ...
  'knowledgeBase.contextBudget.description':
    'Up to {{perFile}} characters per file and {{total}} total are added to each request. Larger files stay searchable, so the agent can retrieve the rest when needed.',
  'knowledgeBase.contextBudget.title': 'Large files won’t inflate every message',
