export default {
  ...
  'version': 'Version',
  'workspaceTransfer.copyError': 'Could not copy to {{name}}',
  'workspaceTransfer.copySuccess': 'Copied to {{name}}',
  'workspaceTransfer.copyTo': 'Copy to…',
  'workspaceTransfer.moveError': 'Could not move to {{name}}',
  'workspaceTransfer.moveSuccess': 'Moved to {{name}}',
  'workspaceTransfer.moveTo': 'Move to…',
  'workspaceTransfer.personal': 'Personal space',
  'zoom': 'Zoom',
};
