...
// VITE_DEV_HOST lets a dev serve the SPA over the LAN (e.g. to test on a phone)
// without patching this file.
export const resolveViteDevOrigin = () =>
  `http://${process.env.VITE_DEV_HOST || 'localhost'}:${Number(process.env.VITE_DEV_PORT) || 9876}`;
